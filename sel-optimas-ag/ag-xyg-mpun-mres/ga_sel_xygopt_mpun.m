...
% PDM. Ademas con los archivos de entrenamiento correctos sirve para cada
% resolucion
...
NOMENTRE=[ 
 'an-u3-14-05_r4.txt';%validacion
 'an-u3-15-03_r4.txt';
 'an-u3-14-04_r4.txt';%entre de aqui pa'bajo
 'an-u3-15-02_r4.txt';
 'an-u3-15-04_r4.txt';
 'an-u3-15-05_r4.txt';
];
...
% Generational loop
   while gen < MAXGEN,
    ...
    % Assign fitness-value to entire population
       %FitnV = ranking(ObjV);
       FitnV= 1-ObjV/sum(ObjV); %desempeño relativo
