%f_alin_e2.m
%Función para alineación por minimización del error cuad. de dos objetos 
%con puntos correspondientes
%Devuelve los valores [ax ay tx ty] de la transformación rígida  que alinea X2 con X1
