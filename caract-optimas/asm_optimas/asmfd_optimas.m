% asmfd_optimas.m
% 21-oct-2004: utiliza veriones optimizadas de calcula_car_opt y de knn_optimas
...
for iteracion=1:2
   ...
   [dX, dY]=busqueda_optimas(XYTI, MGI, MDxGI, MDyGI, MDxxGI, MDyyGI, MDxyGI, CAROPT, MUE_ENTRE, IO, renentre)
