% 
% SFSx1_prostata_tpuntos_perfiles.m
% 20-dic-04: calcula las car optimas de todos los puntos sin/con X1
...
save 'car_opt_todos_puntos_perf.txt' CAROPT -ASCII

save 'car_opt_todos_puntos_sX1_perf.txt' CAROPT_TODAS -ASCII

save 'errores_60car_perf.txt' ERRORES -ASCII

save 'errores_60car_sX1_perf.txt' ERRORESx1 -ASCII
