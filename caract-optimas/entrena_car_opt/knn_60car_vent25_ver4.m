...
for i=1:ren % repetimos el ciclo para todas las imagenes
   ...
   no_puntos=renC+1;
            ...
            for j=1:ancho_v % para la ventana de ancho_v x alto_v
                  ...
                  VECTOR((j-1)*5+i, :)=MOMENTOS; %contiene anch_v x alto_v vectores al final del ciclo i,j
                  %*********************************
           ...
           %imshow(I)
        imwrite(I, 'resultadoparcial16-04b.tif', 'tif');  
