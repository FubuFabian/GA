            ...
            for j=1:ancho_v % para la ventana de ancho_v x alto_v
          		for i=1:alto_v
                   ...
                   for escala=1:5  
                    ...
                    %*******************
                     H=zeros(1,256);
						for bin=0:1 % aqui es hasta 255, 1 es nomas pa'probar
                  ...
                  VECTOR((j-1)*5+i, :)=MOMENTOS; %contiene los 25 vectores de la ventana de 5x5
              end % for i..
      		end % for j..
           % clasificador para landmark=punto
         for pixelventana=1:25            
             contadorD=1;
              for muestraentre=1:25
                 for imagenentre=1:renentre
                    v1=VENT((punto-1)*25+muestraentre,:,imagenentre);
                    v=VECTOR(pixelventana,:);
