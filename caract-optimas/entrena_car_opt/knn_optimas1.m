...
PIXELESPORPERFIL=17;
PIXELESPORVENTANA=25;
				  primerpix=(punto-1)*PIXELESPORVENTANA+1;
               inicio=1;
               for imagenentre=1:renentre
              		ENTRE_TEMP=MUE_ENTRE(primerpix:primerpix+24, CAROPTPUNTO,imagenentre);	
                    	ENTRE_PUNTO_TODOS(inicio:imagenentre*PIXELESPORVENTANA,:)=ENTRE_TEMP;
                    	IO_TEMP=IO(primerpix:primerpix+24, imagenentre);
