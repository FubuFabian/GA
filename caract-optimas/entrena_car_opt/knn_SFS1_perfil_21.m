   ...
   %*********************************************************************
    ...
    for punto=1:no_puntos-1 % para todos los puntos del contorno
           ...
           for k=INFLMT:SUPLMT % para el perfil de longitud SUPLMT-INFLMT
                 ...
                 vectoropt=calcula_car_opt1(MGI, MDxGI, MDyGI, MDxxGI, MDyyGI, MDxyGI, dx, dy , X(punto), Y(punto), CAROPTPUNTO);
           ...
           % keyboard
           %imshow(I)
        imwrite(I, 'resultadoparcial16-04_optimo_1604entre1.tif', 'tif');  
