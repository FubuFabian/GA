...
function F=fobj_optimas(Pop_Real, MEDIA2COL, P10, Limb10, MGI, MDxGI, MDyGI, MDxxGI, MDyyGI, MDxyGI, CAROPT, MUE_ENTRE, IO, renentre)
global ORIX
global ORIY
...
for no_ind=1:rencrom
    ...
    F(no_ind)=evalua_contorno_optimas(XYT, MGI, MDxGI, MDyGI, MDxxGI, MDyyGI, MDxyGI, CAROPT, MUE_ENTRE, IO, renentre);
end
F=F';
