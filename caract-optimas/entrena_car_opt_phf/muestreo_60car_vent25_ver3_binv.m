% muestreo_60car_vent25_ver3_binv.m
...
for imagen=1:ren % repetimos el ciclo para todas las imagenes
   ...
   %*********************************************************************
	...
	beta=1; % ancho del bote (bin) del histograma este programa Si acepta un bin variable
	[renC colC]=size(Cori);
   ...
   nomarchi=strcat('v5x5_60car_binv',nomarchi,'.txt');
