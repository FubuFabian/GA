...
function f=estads_ori(X, Y, YP, nombre_contorno)
...
fid=fopen('estadisticas_ori.rtf', 'a')
fprintf(fid, '%s: p_Cori:%4.4f p_ext_o:%4.4f p_int_o:%4.4f \n', nombre_contorno, Cori, suma_ext, suma_int);
fclose(fid)
f=0;
