% contraste_lip_M_fer.m como en Pinoli (1997) mas o menos!
...
function f=contraste_lip_M_fer(X, Y, YP, invSlip, medialip)
...
f=[[suma_DIF, suma_ext]-medialip]*invSlip*[[suma_DIF, suma_ext]-medialip]';
